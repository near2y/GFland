...
namespace UnityEditor
{
    internal class MyStandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent displayHeightText = EditorGUIUtility.TrTextContent("Display Height");
            public static GUIContent displayEdgeColorText = EditorGUIUtility.TrTextContent("Display Edge Color");
            public static GUIContent displayEdgeWidthText = EditorGUIUtility.TrTextContent("Display Edge Width");
        ...
        MaterialProperty displayHeight = null;
        MaterialProperty diplayEdgeColor = null;
        MaterialProperty displayEdgeWidth = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            displayHeight = FindProperty("_DisplayHeight", props);
            diplayEdgeColor = FindProperty("_EdgeColor", props);
            displayEdgeWidth = FindProperty("_EdgeWidth", props);
        }
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUILayout.Space();
            GUILayout.Label("<  GFLand Shader >", EditorStyles.boldLabel);
            m_MaterialEditor.ShaderProperty(displayHeight,Styles.displayHeightText);
            m_MaterialEditor.ShaderProperty(diplayEdgeColor,Styles.displayEdgeColorText);
            m_MaterialEditor.ShaderProperty(displayEdgeWidth,Styles.displayEdgeWidthText);
        }
