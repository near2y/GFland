...
{
    clip(_DisplayHeight - i.displayHeight);
    ...
    half4 displayEdgeColor = _EdgeColor * step(_DisplayHeight - i.displayHeight, _EdgeWidth);
    c.rgb += displayEdgeColor.rgb;
